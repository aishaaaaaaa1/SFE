...
<p class="doc-catalog-intro">Filtrez par commune ou par type de document. Le bouton <strong>Télécharger</strong> génère une fiche PDF (texte et illustrations) pour chaque entrée.</p>
...
<p class="hint doc-catalog-hint">Le lien «&nbsp;Télécharger&nbsp;» génère une <strong>fiche PDF</strong> (résumé et illustrations issues de cette page). Pour joindre un PDF officiel complet, renseignez le champ <code>pdf</code> dans <code>assets/js/docs-urbanisme-catalog.js</code> (fichiers dans <code>assets/docs-urbanisme/</code>)&nbsp;; le lien pointera alors directement vers ce fichier.</p>
</section>`;
...
<tr><th>Total</th><th>408</th></tr>
  ...
  'planif-documents.html': {
    ...
    extraModuleScripts: ['assets/js/docs-urbanisme-fiche.mjs'],
  },
  'planif-etudes.html': {
    wide: true,
